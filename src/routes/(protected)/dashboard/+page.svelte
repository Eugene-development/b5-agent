...
<div class="dashboard">
	<header class="dashboard-header">
		...
		<div class="user-actions">
			<span class="welcome-text">Welcome, {authState.user?.name || authState.user?.email}!</span>
	...
	<div class="mx-auto max-w-4xl px-6 lg:px-8">
		...
		<div class="mb-8 rounded-lg bg-white/5 p-8 backdrop-blur-sm">
			<div class="mb-4 flex items-center justify-center">
				...
				<h3 class="text-2xl font-semibold tracking-wide text-white">Форма</h3>
			</div>
			<div class="text-center">
				...
				>
					Отправка данных потенциального клиента →
				</a>
			</div>
		</div>

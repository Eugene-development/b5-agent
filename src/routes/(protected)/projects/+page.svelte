...
-->
<svelte:head>
	<title>Мои проекты RUBONUS – Управление клиентами и сделками</title>
	<meta name="description" content="Управление проектами в RUBONUS: список клиентов, статусы сделок, история взаимодействий, фильтрация и поиск проектов. Полный контроль над вашими клиентами." />
	<meta name="keywords" content="проекты RUBONUS, управление клиентами, список сделок, статусы проектов, CRM агента" />
</svelte:head>

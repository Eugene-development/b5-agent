<script>
	...
	const questions = [
		...
		},
		{
			...
			answer:
				'Мы гарантируем получение вами бонусов в течение 5 дней после закрытия сделки. Более того, мы заинтересованы делать это чаще, так как это мотивирует вас на постоянное сотрудничество.'
		}
	];
</script>
...
<div class="relative min-h-screen bg-gray-950">
	...
	<div class="relative mx-auto max-w-4xl px-6 py-20 sm:py-28 lg:px-8">
		...
		<div class="mb-16 text-center">
			...
			<h1 class="mb-4 text-4xl font-bold text-white md:text-5xl">Часто задаваемые вопросы</h1>

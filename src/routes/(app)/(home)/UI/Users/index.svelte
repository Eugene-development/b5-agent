	...
	<div class="relative mx-auto max-w-7xl px-6 lg:px-8">
		...
		<div class="mx-auto max-w-3xl text-center">
			...
			<p class="mx-auto mt-6 max-w-3xl text-lg leading-8 text-gray-300 sm:text-xl">
				Мы предлагаем удобную систему бонусов для разных категорий специалистов, желающих иметь
				дополнительный заработок без лишних усилий.
			</p>
		</div>
		...
		<div class="mx-auto mt-20 grid max-w-7xl grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-2">
			...
			>
				...
				<p class="leading-relaxed text-gray-300">
					...
					мебели. Не теряйте клиента! Передайте его нам и заработайте 5% с каждой сделки.
				</p>
			</div>

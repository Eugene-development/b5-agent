<div
	class="divide-y divide-gray-200 overflow-hidden rounded-t-2xl bg-gray-50 p-24 shadow-sm *:p-8 sm:grid sm:grid-cols-2 sm:divide-y-0"
>
	<div
		class="sm:odd:not-nth-last-2:border-b sm:even:not-last:border-b group relative rounded-tl-lg rounded-tr-lg border-gray-200 bg-gray-50 p-6 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:rounded-tr-none sm:even:border-l"
	>
		<div>
	...
	<div
		class="sm:odd:not-nth-last-2:border-b sm:even:not-last:border-b group relative border-gray-200 bg-white p-6 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:rounded-tr-lg sm:even:border-l"
	>
		<div>
	...
	<div
		class="sm:odd:not-nth-last-2:border-b sm:even:not-last:border-b group relative border-gray-200 bg-white p-6 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:even:border-l"
	>
		<div>
	...
	<div
		class="sm:odd:not-nth-last-2:border-b sm:even:not-last:border-b group relative border-gray-200 bg-gray-50 p-6 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:even:border-l"
	>
		<div>
	...
	<div
		class="sm:odd:not-nth-last-2:border-b sm:even:not-last:border-b group relative border-gray-200 bg-gray-50 p-6 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:rounded-bl-lg sm:even:border-l"
	>
		<div>
	...
	<div
		class="sm:odd:not-nth-last-2:border-b sm:even:not-last:border-b group relative rounded-bl-lg rounded-br-lg border-gray-200 bg-white p-6 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:rounded-bl-none sm:even:border-l"
	>
		<div>

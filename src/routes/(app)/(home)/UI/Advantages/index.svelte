<script>
	...
	const advantages = [
		{
			...
			description:
				'Получайте свои бонусы быстро и без задержек. Бонусы доставляются в течение 5 рабочих после закрытия сделки.',
			icon: 'clock',
			iconBg: 'bg-teal-50',
		...
		},
		{
			...
			description:
				'Фабрика работает только с проверенными партнёрами. Все поставщики материалов проходят тщательную проверку.',
			icon: 'shield-check',
			iconBg: 'bg-purple-50',
		...
		},
		{
			...
			title: 'Высокий доход',
			description:
				'Конкурентные бонусы до 5% без усилий с каждой успешной сделки. Чем больше клиентов - тем выше ваш доход.',
			icon: 'banknotes',
			iconBg: 'bg-yellow-50',
		...
		},
		{
			...
			description:
				'Гарантируем сохранность информации. Все сделки защищены соглашением о персональных данных.',
			icon: 'lock-closed',
			iconBg: 'bg-rose-50',
		...
		},
		{
			...
			description:
				'Бесплатное обучение работе с системой, регулярные вебинары и поддержка для всех участников.',
			icon: 'academic-cap',
			iconBg: 'bg-indigo-50',
	...
	function getIconSvg(iconName) {
		const icons = {
			...
			'lock-closed': `<path d="M18 10.5h.008v.008H18V10.5Zm-3-7.5a3 3 0 1 0-6 0v3h6V3ZM6.75 6.75v-3a5.25 5.25 0 1 1 10.5 0v3h2.25A2.25 2.25 0 0 1 21.75 9v7.5A2.25 2.25 0 0 1 19.5 18.75h-15A2.25 2.25 0 0 1 2.25 16.5V9A2.25 2.25 0 0 1 4.5 6.75h2.25Z" stroke-linecap="round" stroke-linejoin="round" />`,

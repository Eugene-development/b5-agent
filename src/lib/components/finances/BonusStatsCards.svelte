	...
	<div class="rounded-lg bg-gray-800 p-4 border border-gray-700">
		<div class="flex items-center">
			...
			<div class="ml-4">
				...
				<p class="text-xl font-semibold text-amber-500">{formatCurrency(stats.total_pending)}</p>
			</div>
		</div>
	</div>
		...
		<div class="flex items-center justify-between">
			<div class="flex items-center">
				...
				<div class="ml-4">
					...
					<p class="text-xl font-semibold text-green-500">{formatCurrency(stats.total_available)}</p>
				</div>
			</div>
	...
	<div class="rounded-lg bg-gray-800 p-4 border border-gray-700">
		<div class="flex items-center">
			...
			<div class="ml-4">
				...
				<p class="text-xl font-semibold text-blue-500">{formatCurrency(stats.total_requested || 0)}</p>
			</div>
		</div>
	</div>
	...
	<div class="rounded-lg bg-gray-800 p-4 border border-gray-700">
		<div class="flex items-center">
			...
			<div class="ml-4">
				...
				<p class="text-xl font-semibold text-cyan-500">{formatCurrency(stats.total_paid)}</p>
			</div>
		</div>
	</div>
	...
	<div class="rounded-lg bg-gray-800 p-4 border border-gray-700">
		<div class="flex items-center">
			...
			<div class="ml-4">
				...
				<p class="text-xl font-semibold text-purple-500">{formatCurrency(total)}</p>
			</div>
		</div>
	</div>
</div>

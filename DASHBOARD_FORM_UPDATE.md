...
### 1. Добавлена форма в модальном окне
- Создан новый компонент `ProjectSubmitModal.svelte`
- Форма открывается по клику на кнопку "Форма на сайте"
- Форма использует тот же API endpoint, что и форма в проекте b5-mm

### 2. Две кнопки для создания проекта
На странице Dashboard добавлены две кнопки:

**Форма на сайте:**
- Открывает модальное окно с формой
- Секретный ключ подставляется автоматически
- Удобно для быстрого создания проектов

**Анонимная форма в Telegram:**
- Ссылка на Telegram бот: `https://t.me/mytestbot_2025_v1_bot`
- Требует ручного ввода секретного ключа
- Для тех, кто предпочитает работать через Telegram
